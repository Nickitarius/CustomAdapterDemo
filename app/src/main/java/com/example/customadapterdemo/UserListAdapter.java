...
public class UserListAdapter extends BaseAdapter {
    ...
    public void sortByName() {
        ...
        for (int i = users.size() - 1; i > 0; i--) {
            for (int j = 0; j < i; j++) {
                if (users.get(j).name.compareTo(users.get(j + 1).name) > 0) {
                    tmp = users.get(j);
    ...
    public void sortBySex() {
        ...
        for (int i = users.size() - 1; i > 0; i--) {
            for (int j = 0; j < i; j++) {
                if (users.get(j).sex.compareTo(users.get(j + 1).sex) > 0) {
                    tmp = users.get(j);
                    users.set(j, users.get(j + 1));
                    users.set(j + 1, tmp);
                }
    ...
    public void sortByPhoneNumber() {
        ...
        for (int i = users.size() - 1; i > 0; i--) {
            for (int j = 0; j < i; j++) {
                if (users.get(j).phoneNumber.compareTo(users.get(j + 1).phoneNumber) > 0) {
                    tmp = users.get(j);
                    users.set(j, users.get(j + 1));
                    users.set(j + 1, tmp);
                }
